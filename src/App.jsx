...
function App() {
  return (
      <div className="h-screen w-screen bg-black m-0 px-12 overflow-hidden">
          ...
          <Router>
            <section className="fixed inset-0 w-full h-full sm:md:py-10 sm:md:px-20">
              <div className="border backdrop-blur-xl bg-[#61616122] border-[#ffffff22] sm:md:overflow-visible overflow-y-scroll rounded-[1rem] h-full py-4 px-5 md:px-10">
                <Nav/>
                <div className="">
                  <Routes>
